...
public static class EnsEventHandlers
{
	...
	public static async Task<EnsEventResult?> HandleAsync(
	...
	private static async Task<EnsEventResult> HandleForward(
	...
	private static async Task<EnsEventResult> HandleReverseAsync(

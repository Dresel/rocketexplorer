...
dotnet tool run Nethereum.Generator.Console generate from-abi -abi abis\rocketNodeStaking.json -o ./Clients -cn RocketNodeStaking -ns RocketExplorer.Ethereum -sf true
